(
    function () {
        ...
        /*step 1: Loop through the countries
          step 2: get the data of each country.
          step 3: Build the option tag like
              <option value="code">countryname</option>
          step 4: attach the option tag to its parent i.e. select tag
          step 5: repeat the step 3,4 for each country.
        ...
        function readData() {
            ...
            var indexData = ctrls.countries.value;
